...
class CourseForms:
	def __init__(self):
		self.df_ = pd.read_csv('data/CNPC_1401-1509_DI_v1_1_2016-03-01.csv', usecols=['userid_DI', 'completed_%', 'grade', 'discipline', 'course_id_DI'])
	...
	def retrieveCoursesByUserID(self, userID):
		df = self.df_.query('userid_DI == ' + userID)
